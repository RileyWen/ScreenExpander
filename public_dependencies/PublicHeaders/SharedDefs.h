...
#define IOCTL_ADJUST_EXISTING_MONITOR   INDIRECT_DISP_IOCTL_USER_RW(0x1)

#define IOCTL_ADAPTER_ECHO              INDIRECT_DISP_IOCTL_USER_RW(0x3)

constexpr size_t MAX_MONITOR_NUM = 8;
...
} MONITOR_ARRIVE_ARG_IN, * PMONITOR_ARRIVE_ARG_IN;
...
typedef struct {
    DWORD dwMonitorIndex;
} MONITOR_DEPART_ARG_IN, * PMONITOR_DEPART_ARG_IN;
